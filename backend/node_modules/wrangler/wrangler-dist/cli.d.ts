...
declare class ConfigController extends Controller<ConfigControllerEventMap> {
    ...
    patch(input: Partial<Options>): void;
    latest?: Options;
    teardown(): Promise<void>;
    emitConfigUpdateEvent(config: Options): void;
}
...
declare type FilePath<Path = string> = Extract<File_2<undefined, Path>, {
    path: Path;
}>;
...
declare type HookValues = string | number | boolean | object;
...
declare type Options = StartDevWorkerOptions;
